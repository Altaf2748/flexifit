          ...
          <div className="flex flex-col gap-4 justify-center items-center px-8 py-8 w-full lg:flex-row-reverse sm:gap-12">
            ...
            >
              ...
              <img
                src="heo.png"
                alt="Fitness"
                className="object-contain relative py-8 pt-4 mx-auto w-60 max-w-xl drop-shadow-2xl md:w-full md:pt-0 scale-75"
              />
            </motion.div>
          ...
          <div className="grid grid-cols-1 gap-12 md:grid-cols-2 xl:grid-cols-4">
            <div>
              <div className="flex gap-4 items-center mb-4">
                ...
                <h1 className="text-3xl font-bold">FlexiFit</h1>
              </div>
