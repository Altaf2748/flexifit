...
const DefaultPage = () => {
  ...
  const testimonials = [
    { name: "Karan.", role: "Fitness Enthusiast", quote: "FlexiFit has transformed my fitness journey. I love how easy it is to track my workouts and stay motivated!", rating: 5 },
    ...
    { name: "John D.", role: "Gym Owner", quote: "FlexiFit has helped my gym members stay consistent and achieve their goals faster.", rating: 4 },
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <div className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold text-center mb-16">Why Choose FlexiFit?</h2>
